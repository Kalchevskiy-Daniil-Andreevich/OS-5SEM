#include <Windows.h>
#include <iostream>
//можноо несколько потоков может использовать ресурсы
using namespace std;
...
int main()
{
    ...
    LPCWSTR an1 = L"D:\\ОС\\Лабораторная работа №6\\OS06\\x64\\Debug\\OS06_04A.exe";
    LPCWSTR an2 = L"D:\\ОС\\Лабораторная работа №6\\OS06\\x64\\Debug\\OS06_04B.exe";
